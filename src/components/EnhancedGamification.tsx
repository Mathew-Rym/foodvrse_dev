...
const EnhancedGamification: React.FC = () => {
  ...
  useEffect(() => {
    if (showBadgeAnimation) {
      const timer = setTimeout(() => setShowBadgeAnimation(null), 3000);
