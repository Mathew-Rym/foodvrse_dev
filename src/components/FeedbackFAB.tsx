  ...
  return (
    <>
      ...
      <Button
        ...
        className={`fixed right-6 z-40 w-14 h-14 rounded-full bg-brand-yellow text-brand-green shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 animate-[gentle-glow_10s_ease-in-out_infinite] ${
          isAuthenticated ? 'bottom-24' : 'bottom-6'
        }`}
        style={{
          filter: 'drop-shadow(0 0 10px rgba(252, 218, 91, 0.8))'
        }}
        size="sm"
      >
