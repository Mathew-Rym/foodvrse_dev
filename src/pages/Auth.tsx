                    ...
                    <FormItem>
                      <FormControl>
                        <Input 
                          ...
                          className="bg-white/20 border-gray-500 text-white placeholder:text-gray-300 rounded-xl py-3 focus:border-green-500 focus:ring-2 focus:ring-green-500/20"
                          {...field} 
                        />
                      </FormControl>
                    ...
                    <FormControl>
                      <div className="relative">
                        <Input 
                          ...
                          className="bg-white/20 border-gray-500 text-white placeholder:text-gray-300 rounded-xl py-3 pr-10 focus:border-green-500 focus:ring-2 focus:ring-green-500/20"
                          {...field} 
                        />
                        <button
                          type="button"
